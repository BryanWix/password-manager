...
import { Singleltem } from "../Singleltem";
import { dataSidebarConfiguration, dataSidebarElements } from "./SiderbarRoutes.data";
import { signOut } from "next-auth/react";

export function SidebarRoutes() {
  return (
      <div>
        <Singleltem href="/" label="Homepage" icon={House} />
        ...
        <Singleltem href="/analytics" label="Analytics" icon={BarChart} />
